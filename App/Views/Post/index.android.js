...
var Post = React.createClass({
  ...
  fetchData: function() {
    fetch(api.HN_ITEM_ENDPOINT+this.props.post.post_id+'.json')
  ...
  renderCommentsHeader: function(){
    if(!this.state.loaded){
      ...
      <View style={styles.container}>
          ...
          <Text style={styles.commentTitle}>{this.props.post.post_comments_count} Comments:</Text>
    ...
    return(
      <View style={styles.container}>
          ...
          <Text style={styles.postDetailsLine}>
            Posted by {this.props.post.post_by} | {this.props.post.post_points_count} Points
          </Text>
          <View style={styles.separator}/>
          <Text style={styles.commentTitle}>{this.props.post.post_comments_count} Comments:</Text>
          </View>
